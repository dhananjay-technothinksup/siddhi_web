...
<head>
  <meta charset="utf-8">
  <title>Siddhi Sales Corporation</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Products<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="<?php echo base_url(); ?>Shell" >Shell</a></li>

                      <!-- <li><a href="<?php echo base_url(); ?>Houghton" >Houghton</a></li> -->
                      <li><a href="<?php echo base_url(); ?>Quaker-Houghton" >Quaker Houghton</a></li>
                        <li><a href="<?php echo base_url(); ?>ContiTech" >ContiTech</a></li>
                    </ul>
                  </li>
                  <li>
